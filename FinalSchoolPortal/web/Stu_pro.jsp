                        ...
                        <div class="container_12">
                            <div class="wrapper">
                                <article class="grid_4">
                                    ...
                                    %>
                                    <h50><%=sc_name%></h50><br><br><br>

                                    <a href="editing.jsp" >Edit Profile</a><br><br><br>
                                    <a href="School_vendor_relate.jsp">Collaboration Messages </a><br><br><br>
                                    <a href="Vendor.jsp">Vendors</a><br><br><br>
                                ...
                                <article class="grid_8">
                                    ...
                                    <article class="grid_77">
                                        ...
                                        <%
                                            try {
                                                ...
                                                String qry1 = "select * from student_base where school_name='"+sc_name+ "'";
                                        ...
                                        %>  
                                        <a class="dis" href="Stu_pro.jsp?id=<%=rs.getString("student_id")%>" >    
                                    ...
                                    <article class="grid_07"> <br>
                                        <center><b> <h25>Student Profile</h25></b></center>
                                                <%
                                                    String id = request.getParameter("id");
                                                    String qry = "select * from student_base where student_id='" + id + "'  ";
                                                ...
                                                %> 
                                        <br><br><br>
                                         <label><span class="text-form"><h25>Student Name </h25></span>
                                             <b>  <%= rs1.getString("student_name")%></b><br><br><br>
                                            </label>
                                            
                                             <label><span class="text-form"><h25>Email id </h25></span>
                                                 <b> <%= rs1.getString("student_email")%></b><br><br><br>
                                            </label>
                                             <label><span class="text-form"><h25>Gender </h25></span>
                                                 <b>   <%= rs1.getString("student_gender")%></b><br><br><br>
                                            </label>
                                             <label><span class="text-form"><h25>Address </h25></span>
                                                 <b>   <%= rs1.getString("student_address")%></b><br><br><br>
                                            </label>
                                               <%
                                                    }%>
