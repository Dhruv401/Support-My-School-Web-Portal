                                    ...
                                    <article class="grid_07">
                                        ...
                                        <%
                                            try {
                                                ...
                                                while (rs.next()) {
                                        %>
                                        <a href="Server_4.jsp?name=<%=rs.getString("name")%>">
                                    ...
                                    <article class="grid_77"><br><br>
                                        <h50>Description</h50><br><br>
                                            <%
                                                ...
                                                String qr25 = "select * from vendor_master where vendor_name='" + let + "' AND ven_id=(SELECT max(ven_id) from vendor_master where vendor_name='" + let + "') ";

                                                ResultSet rs25 = st.executeQuery(qr25);
                                                while (rs25.next()) {
                                            %>
                                        Name:     <%=rs25.getString("vendor_name")%><br><br><br>
                                        Website:  <%=rs25.getString("vendor_website")%><br><br><br>
                                        Shop name:<%=rs25.getString("shop_name")%><br><br><br>
                                        Type :<%=rs25.getString("vendor_description")%><br><br><br>
<a href="Server_4Serv?name=<%=rs25.getString("vendor_name")%>  ">Delete This Entry</a>
