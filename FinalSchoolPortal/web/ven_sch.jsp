		...
		<div class="content-bg">
            <div class="main">
                <div class="container_12">
                 ...
                 <b><h3>
				School List<br><br><a href="ven_sch.jsp">
				  <%
                                                try{
                                                    ...
                                                    String db="schoolportal";
                                                     String url="jdbc:mysql://localhost:3306/";
                                                      String user="root";
                                                     String password="";
                                                     String qry="select * from main_master where identity_sc='school' ";       
				...
				<article class="grid_8">
                                    <%      // SESSION    String qr2="select name from main_master where req_id='2'";
                                    ResultSet rs2=st.executeQuery(qry);
                                    while(rs2.next()){
                                    %>
                                    <h3><%= rs2.getString("name") %><br><br></h3>
                        <%}%>
                        
                        <%
                                    String qr1="select * from school_master";
                                    ResultSet rs1=st.executeQuery(qr1);
                                    while(rs1.next()){
                        %>
                        School 1 Profile<br><br>
                        Website :<%=rs1.getString("school_website") %><br><br>
                        Address : <%=rs1.getString("school_address") %> <br><br>
                        Phone no : <%=rs1.getString("school_phone") %><br><br>
                        Medium : <%=rs1.getString("school_medium") %><br><br>
