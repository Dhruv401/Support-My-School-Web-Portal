                        ...
                        <div class="container_12">
                            <div class="wrapper">
                                  ...
                                  <br>
                                    ...
                                    <div class="verticle_bar">
                                        <ul><br><br>
                                            ...
                                            <li><a href="Editing_for_ven.jsp">Update Profile</a></li><br><br><br>
                                            <li><a href="ven_coll.jsp">Collaboration Messages</a></li><br><br><br>
                                            <li><a href="School.jsp">School List</a></li><br><br><br>
                                ...
                                <article class="grid_8">
                                    <br><br>
                                    <h50><b>My Profile</b></h50><br><br><br>
                                    ...
                                    <%
                                        try {
                                            ...
                                            String qry = "select * from vendor_master where vendor_name='" + nnm + "' AND ven_id=(SELECT max(ven_id) from vendor_master where vendor_name='" + nnm + "')  ";
                                    ...
                                    <label><span class="text-form"><h25> Shop name: </h25></span>
                                        <h26><%=rs.getString("shop_name")%></h26>
                                    </label><br><br><br><br>
                                    <label><span class="text-form"><h25> Website: </h25></span>
                                        <h26><%=rs.getString("vendor_website")%></h26>
                                    </label><br><br><br><br>
                                    <label><span class="text-form"><h25> Description: </h25></span>
                                        <h26><%=rs.getString("vendor_description")%></h26>
                                    </label><br><br><br><br>
                                    <label><span class="text-form"><h25> Phone no:  </h25></span>
                                        <h26><%=rs.getString("vendor_phone")%></h26>
                                    </label><br><br><br><br>
                                    <label><span class="text-form"><h25>Vendor type: </h25></span>
                                        <h26><%=rs.getString("vendor_type")%></h26>
                                    </label><br><br><br><br>
