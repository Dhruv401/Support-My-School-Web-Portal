                            ...
                            <div class="wrapper">
                                <article class="grid_4">
                                  ...
                                  <br>
                                    ...
                                    <br><br>
                                  <li><a href="Editing_for_ven.jsp">Update Profile</a></li><br><br>
                                    <li><a href="School.jsp">School List</a></li><br><br>
                                    <li><a href="Stu.jsp">Student List </a></li><br><br>

                                </article>

                                <article class="grid_8">
                                <br><br>
                                    <h3><b>School - Vendor Communication</b>
                                    </h3>
                                    <br><br>
                                    <br>

                                    <a class="dis"  href=" ven_compose.jsp" target="_top">Compose Message</a><br><br><br><br>
                                    <a class="dis" href=" ven_msg.jsp" target="_top">Inbox</a> <br><br><br><br>
                                    <a class="dis" href="ven_msg_sent.jsp" target="_top">Sent Messages</a> 
