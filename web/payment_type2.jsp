                        ...
                        <div class="container_12">
                            <div class="wrapper">
                                ...
                                <article class="grid_8">
                                    ...
                                    <h3><b>By Card</b></h3><br><br>  
                                    <form name="Card" method="post" action="payment_type2Servlet" id="contact-form2">
                                        <fieldset>                   	
                                            <label><span class="text-form">Name:</span>
                                                <input name="user_name" type="text" size="45px" required="required"/>
                                            </label> 
                                            <label><span class="text-form">Email:</span>
                                                <input name="user_email" type="text" size="45px" required="required"/>
                                            </label>

                                            <label><span class="text-form">Card Type :</span>
                                                <select required="required">
                                                    <option name="cardtype">VISA CARD</option> 
                                                    <option name="cardtype">MASTER CARD</option> 
                                                    <option name="cardtype">INTERNATIONAL CARD</option> 
                                                    <option name="cardtype">OTHER</option> 
                                                </select>
                                            </label>


                                            <label><span class="text-form">Verification 16 digit code</span>
                                                <input name="user_verificationcode" type="text" size="45px" required="required"/>
                                            </label>
                                            <label><span class="text-form">Address</span>
                                                <textarea name="user_address" required="required"></textarea>
                                            </label>
                        ...
                        <div class="wrapper">
                            <article class="grid_8">
                                ...
                                this.value = 'Email'" onFocus="if (this.value == 'Email')
                                        ...
                                        <label>
                                            <input name="subject" value="Subject" onBlur="if (this.value == '')
                                this.value = 'Subject'" onFocus="if (this.value == 'Subject')
                                            this.value = ''" />
                                        </label>
                                        <textarea name="textarea" onFocus="if (this.value == 'Message')
