                        ...
                        <div class="container_12">
                            <div class="wrapper">
                                <article class="grid_4">
                                    ...
                                    <a href="vendor_stu.jsp">Shopping</a><br><br><br><br>
                                ...
                                <article class="grid_8">
                                    ...
                                    <article class="grid_77"><br>
                                        ...
                                        <%
                                            try {
                                                ...
                                                while (rs.next()) {
                                        %><a class="dis" href="ven-list_forstu_2.jsp?name=<%=rs.getString("name")%>">
                                            <%=rs.getString("name")%>
                                            <br><br><br>
                                            <%}
                                            %> </a>
                                    ...
                                    <article class="grid_77"><br><br>
                                        <h25>  Vendor collaborated with these Schools.</h25>

                                        <%
                                            String name = request.getParameter("name");
                                            String v_name = "";
                                            String qwe = "select * from accept_msg where vendor_name='" + name + "' ";

                                            ResultSet rsd = st.executeQuery(qwe);
                                            while (rsd.next()) {

                                        %><br><br><br>
                                        <h50><%=rsd.getString("school_name")%></h50>
