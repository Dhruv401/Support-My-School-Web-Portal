                ...
                <div class="row-top">
                    <div class="main">
                        <div class="wrapper">
                            ...
                            <div class=ls>
                                <pre><a href="signUP.jsp"   target="_top">Register</a></pre>
                            </div>
                        </div>
                        ...
                        <div class="container_12">
                            <div class="wrapper">
                                <article class="grid_4">				 <br><br><br>
                                    <img src="school_ven_mg.jpg" height="140px" width="230px"/>
                                    
                                      </article>
                                <article class="grid_8">

                                    <h3>SCHOOL / VENDOR LOGIN</h3><br>
                                    <form name="sch_ven_signup" method="post" action="loginpageServlet" id="contact-form2">
                                        <fieldset>
                                            ...
                                            <br>
                                            <label><span class="text-form"><a href="forget_pass.jsp">Forget Password</a></span>
