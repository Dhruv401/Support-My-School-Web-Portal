                    ...
                    <div class="container_12">
                        <div class="wrapper">
                        	<article class="grid_8">
                                    ...
                                    Enter your email and we will send you<br> password to that id after verification.
                                    <br><br><br>
                                    <form id="contact-form2" method="post" name="pass_recover2" action="ForgetServ2">                    
                                    <fieldset>
                                        <label><span class="text-form"><h50>Email id : </h50></span>
                                                <input name="email" type="text"  size="45px" required="required" />
                                            </label>
                                        <br>
                                         <label><span class="text-form">-</span>
                                                <input name="submit" type="submit" size="45px"/>
                                            </label>
