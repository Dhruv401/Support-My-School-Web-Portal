                                    ...
                                    <article class="grid_07">
                                        ...
                                        <%
                                            try {
                                                ...
                                                while (rs.next()) {
                                        %>
                                        <a href="Server_2.jsp?name=<%=rs.getString("name")%>">
                                            <%=rs.getString("name")%><br><br><br>
                                            <%
                                                }
                                            %></a> 
                                    ...
                                    <article class="grid_77"><br><br>
                                        <h50>Description</h50><br><br>
                                            <%
                                                ...
                                                String qr25 = "select * from school_master where school_name='" + let + "' AND school_id=(SELECT max(school_id) from school_master where school_name='" + let + "' )   ";

                                                ResultSet rs25 = st.executeQuery(qr25);
                                                while (rs25.next()) {
                                            %>
                                        Name:    <%=rs25.getString("school_name")%><br><br><br>
                                        Website:   <%=rs25.getString("school_website")%><br><br><br>
                                        Contact no: <%=rs25.getString("school_phone")%><br><br><br>
                                        Address: <%=rs25.getString("school_address")%><br>
                                        <br><br>
                                        <a href="Server_2Serv?name=<%=rs25.getString("school_name")%>  ">Delete This Entry</a>
