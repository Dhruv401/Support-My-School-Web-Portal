...
<a href="school_stu.jsp" >Logout</a>
            ...
            <div class="main">
                <div class="container_12">
				 ...
				 <article class="grid_4">
					Shopname<br><br>
					Book Name<br><br>
					<img src="Sch_lg.jpeg" width="95" height="131" align="left">
					
					</article>
					
                      <article class="grid_8">
                        
						<h3><b>Payment Mode</b></h3><br><br>  	
						<input type="radio"  onClick="window.open('payment_type1.jsp')">Cash On Delivery<br><br> 
				<input type="radio"   onClick="window.open('payment_type2.jsp')">	Credit Card<br><br>
    ...
    </div>   <!---- this div is above header tag---->
