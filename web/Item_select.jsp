                    ...
                    <div class="main">
                        <nav class="indent-left">
                            <ul class="menu wrapper">
                                ...
                                <li><a href="site/vision_another.jsp">Vision</a></li>
		...
		<div class="content-bg">
            <div class="main">
                <div class="container_12">
                    ...
                    ShopName<br><br>
					<img src="Sch_lg.jpeg" width="123" height="154" align="left"><br>
					<br><br><br><br><br>
                      ...
                      <article class="grid_8">
					   ...
					   <b>PRICE</b><br><br>
					   Rs. 250<br><br>
						<input name="button" type="button" value="Buy Now" onClick="window.open('mode_select.jsp')"><br>
                        
                        
                        <input name="button" type="button" value="Add To Cart" onClick="window.open('Add_cart.jsp')"><br>
                        
						
						
						<h3>Related Items</h3><br><br>
					<img src="Sch_lg.jpeg" width="72" height="115" align="left" onClick="window.open('Items.jsp')" >
					
					<img src="Sch_lg.jpeg" width="94" height="116" align="left"  onClick="window.open('Items.jsp')">
						
						
						
						<img src="Sch_lg.jpeg" width="79" height="117" align="left"  onClick="window.open('Items.jsp')">
						<img src="Sch_lg.jpeg" width="92" height="116" align="left"  onClick="window.open('Items.jsp')" >				      </article>
                    </div>
                </div>
            </div>
            <div class="block"></div>
