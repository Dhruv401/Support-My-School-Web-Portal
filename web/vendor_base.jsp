                                ...
                                <article class="grid_4">
                                    ...
                                    <div class="verticle_bar">
                                        <ul><br><br>
                                            ...
                                            <li><a href="web_visit.jsp">Website visited Students </a></li><br><br><br>
                                   ...
                                   <br>
                                    ...
                                    <%
                                        try {
                                            ...
                                            String user = "root";
                                            String password = "";
                                            String qry = " select * from vendor_master where vendor_name='" + sc_name + "' AND ven_id=(SELECT max(ven_id) from vendor_master where vendor_name='" + sc_name + "' )   ";
