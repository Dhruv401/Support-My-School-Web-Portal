...
<br><br>
                                ...
                                <article class="grid_8">
                                    ...
                                    <article class="grid_07">
                                        ...
                                        <%   //from here
                                            try {
                                                ...
                                                String qry = "select * from accept_msg where school_name='" + sch + "' ";

                                                Class.forName(Driver).newInstance();
                                                Connection con = DriverManager.getConnection(url + db, user, password);
                                                Statement st = con.createStatement();
                                                ResultSet rs = st.executeQuery(qry);
                                        %><br><h50>Accepted Messages</h50><br><br><br><%
                                            while (rs.next()) {
                                            %>  
                                        <a class="dis" href="sch_sent_2.jsp?id=<%=rs.getString("here_id")%>">
                                            <li value="ol"><%= rs.getString("msg_name")%></li>
                                            <br><br>
                                        </a>
                                        <%}%><br>
                                        </a> 
                                    ...
                                    <article class="grid_77">
                                        <br><br>
                                        <h25>			
                                            Message Details </h25><br><br><br>

                                        <%
                                            String id = request.getParameter("id");

                                            String qry1 = "select * from accept_msg where here_id='" + id + "'  ";
