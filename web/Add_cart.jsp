                ...
                <div class="container_12">
                    <div class="wrapper">
                      <article class="grid_4">
						...
						<img src="Sch_lg.jpeg" width="95" height="131" align="left"><br><br>
							<h3><b>ShopName</b></h3><br><br>  	<br>
					
					Items<input type="text" value="Search"><br><br>
					<a href="base_shop.jsp">Bags</a><br><br>
		            <a href="base_shop.jsp">Books<br><br>
					<a href="base_shop.jsp">Uniform<br><br>
					<a href="base_shop.jsp">Stationary<br><br>
					<a href="base_shop.jsp">Shoes
