                        ...
                        <div class="main">
                            <nav class="indent-left">
                                <ul class="menu wrapper">
                                    <li class="active"><li>
                                        <a href="school_sch.jsp">Home</a></li>
...
<br>
                                    ...
                                    <br>
                                    <a href="coll_req.jsp" target="_top">Inbox</a> <br><br><br>

                                    <a href="sch_sent.jsp" target="_top">My Responses</a>
                                ...
                                <article class="grid_8">
                                    ...
                                    <article class="grid_77">
                                        ...
                                        <%   //from here
                                            ...
                                            try {
                                                ...
                                                String sc_name = (String) sess.getAttribute("name1");
                                                String qry = "select * from vendor_compose where school_name='" + sc_name + "' ";

                                                Class.forName(Driver).newInstance();
                                                Connection con = DriverManager.getConnection(url + db, user, password);
                                                Statement st = con.createStatement();
                                                ResultSet rs = st.executeQuery(qry);
                                        %><br><h50>Messages</h50><br><br><br><%
                                            while (rs.next()) {
                                            %>  
                                        <a class="dis" href="msg_description.jsp?id=<%=rs.getString("ven_id")%>">
                                            <li value="ol"><%= rs.getString("vendor_msg_name")%></li>
                                            <br><br>
                                        </a>
                                        <%}%><br>
                                        </a> 
                                    ...
                                    <article class="grid_07">
                                        <br>
                                        <h25>			
                                            Message Description </h25><br><br><br>

                                        <%

                                            String id = request.getParameter("id");
                                            String qry1 = "select * from vendor_compose where ven_id='" + id + "'   ";
                                        ...
                                        <b>
                                            <label><span class="text-form">Message Name:</span>
                                                <%=rs1.getString("vendor_msg_name")%>
                                            </label>   <br><br>
                                            <label><span class="text-form">Vendor Name:</span>
                                                <%=rs1.getString("vendor_name")%>
                                            </label>   <br><br>
                                            <label><span class="text-form">Product Detail:</span>
                                                <%=rs1.getString("product_detail")%>
                                            </label>   <br><br>
                                            <label><span class="text-form">Duration Period:</span>
                                                <%=rs1.getString("duration_period")%>
                                            </label>   <br><br>
                                            <label><span class="text-form">Offer Detail:</span>
                                                <%=rs1.getString("offer_detail")%>
                                            </label>   <br><br>
                                            <label><span class="text-form">Profit & policy:</span>
                                                <%=rs1.getString("percentage_profit")%>
                                            </label>   <br><br>
                                        </b>

                                        <br><br>

                                        <!---  check this one---->        <a class="accde" href = "msg_descrptionServlet?id=<%=rs1.getString("ven_id")%>& pp= g " >  ACCEPT</a>  :  To Accept Message  <br><br><br>

                                        <a class="accde" href ="Msg_Decline?id=<%=rs1.getString("ven_id")%>& pp=<%=999%>"> DECLINE</a>  : To Decline Message <br><br> 
                                        <%
