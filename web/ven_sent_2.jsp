                            ...
                            <div class="wrapper">
                                ...
                                <article class="grid_8">
                                    ...
                                    <article class="grid_77"><br><br>
                                        <b>  <h50>Message Description</h50></b><br><br><br>
                                                <%
                                                    String id = request.getParameter("id");
                                                    String qry123 = "select * from vendor_compose where ven_id='" + id + "' ";
                                                    ResultSet rs123 = st.executeQuery(qry123);
                                                    while (rs123.next()) {
                                                %>

<h26>
    <label><span class="text-form"><h25>Vendor Name </h25></span>
                                            <%=rs123.getString("vendor_name")%>
                                        </label><br><br><br>
                                        
                                         <label><span class="text-form"><h25>Message Name </span>
                                            <%=rs123.getString("vendor_msg_name")%>
                                        </label><br><br><br>
                                        
                                        <label><span class="text-form"><h25>School Name</h25> </span>
                                            <%=rs123.getString("school_name")%>
                                        </label><br><br><br>
                                        
                                        <label><span class="text-form"><h25>Product Detail</h25> </span>
                                            <%=rs123.getString("product_detail")%>
                                        </label><br><br><br>
                                        
                                        <label><span class="text-form"><h25>Time Period</h25></span>
                                            <%=rs123.getString("duration_period")%>
                                        </label><br><br><br>
                                        
                                        <label><span class="text-form"><h25>Percent Profit</h25></span>
                                            <%=rs123.getString("percentage_profit")%>
                                        </label><br><br><br>
                                        
                                        <label><span class="text-form"><h25>Offer Detail</h25></span>
                                            <%=rs123.getString("offer_detail")%>
                                        </label><br><br><br>
                                        
                                        <label><span class="text-form"><h25>Extra Detail</h25></span>
                                            <%=rs123.getString("extra_detail")%>
                                        </label><br><br><br>
