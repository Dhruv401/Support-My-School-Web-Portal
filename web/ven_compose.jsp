                            ...
                            <div class="wrapper">
                                <article class="grid_4">
                                  ...
                                  <br>
                                    ...
                                    <a href ="ven_msg_sent.jsp" target="_top">Sent</a>
                                </article>


                                <article class="grid_8">
                                    <h3><b>School - Vendor Relation</b><br>
                                    </h3>
                                    <form id="contact-form2" method="post"  action="ven_composeServlet">
                                        <fieldset>  
                                            <label><span class="text-form">Vendor Name:</span>
                                                <input name="vendor_name" type="text" size="45px" required="required"/>
                                            </label>

                                            <label><span class="text-form">  
                                                    Message Name:
                                                </span>
                                                <input type="text" name="vendor_msg_name" size="45 px" required="required"><br><br>
                                            ...
                                            <label><span class="text-form">Duration Period:</span>
                                                <input name="duration_period" type="text" size="45px" required="required"/>
                                            </label>

                                            <label><span class="text-form">Product Details:</span>
                                                <textarea name="product_detail" style="width:250px; height:150px;" ></textarea>
                                            </label>

                                            <br>

                                            <label><span class="text-form">Offer Details:</span>
                                                <input name="offer_detail" type="text" size="45px" />
                                            </label>
                                            <label><span class="text-form">Percentage Profit:</span>
                                                <input name="percentage_profit" type="text" size="45px" required="required" />
                                            </label>
                                            <label><span class="text-form">Extra Details:</span>
                                                <textarea name="extra_detail" style="width:250px; height:150px;"> </textarea>
                                            </label>                     
                                            <br>
                                            <label> <span class="text-form">
                                                    <input type="submit" name="submit" value="Send to School" />
                                                </span>
